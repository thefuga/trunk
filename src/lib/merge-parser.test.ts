...
describe('computeOutput', () => {
  ...
  function makeRegions(): ConflictRegion[] {
    return [
      { type: 'context', baseLines: ['A'], oursLines: ['A'], theirsLines: ['A'] },
      { type: 'conflict', baseLines: ['B'], oursLines: ['X'], theirsLines: ['Y'] },
      { type: 'context', baseLines: ['C'], oursLines: ['C'], theirsLines: ['C'] },
    ];
  }
...
describe('takeAllCurrent', () => {
  it('returns a Set containing all ours line keys from all conflict regions', () => {
    const regions: ConflictRegion[] = [
      { type: 'context', baseLines: ['A'], oursLines: ['A'], theirsLines: ['A'] },
      { type: 'conflict', baseLines: ['B'], oursLines: ['X1', 'X2'], theirsLines: ['Y1'] },
      { type: 'context', baseLines: ['C'], oursLines: ['C'], theirsLines: ['C'] },
      { type: 'conflict', baseLines: ['D'], oursLines: ['Z1'], theirsLines: ['W1'] },
    ];
...
describe('takeAllIncoming', () => {
  it('returns a Set containing all theirs line keys from all conflict regions', () => {
    const regions: ConflictRegion[] = [
      { type: 'context', baseLines: ['A'], oursLines: ['A'], theirsLines: ['A'] },
      { type: 'conflict', baseLines: ['B'], oursLines: ['X1'], theirsLines: ['Y1', 'Y2'] },
      { type: 'context', baseLines: ['C'], oursLines: ['C'], theirsLines: ['C'] },
      { type: 'conflict', baseLines: ['D'], oursLines: ['Z1'], theirsLines: ['W1'] },
    ];
...
describe('getConflictIndices', () => {
  it('returns indices of conflict regions only', () => {
    const regions: ConflictRegion[] = [
      ...
      { type: 'conflict', baseLines: ['B'], oursLines: ['X'], theirsLines: ['Y'] },
      { type: 'context', baseLines: ['C'], oursLines: ['C'], theirsLines: ['C'] },
      { type: 'conflict', baseLines: ['D'], oursLines: ['Z'], theirsLines: ['W'] },
      { type: 'context', baseLines: ['E'], oursLines: ['E'], theirsLines: ['E'] },
    ];
