...
| --fg-2 on --bg-0 | `var(--fg-2)` | `var(--bg-0)` | 7.18 | ✅ AAA |
| --fg-2 on --bg-1 | `var(--fg-2)` | `var(--bg-1)` | 7.13 | ✅ AAA |
| --fg-2 on --bg-2 | `var(--fg-2)` | `var(--bg-2)` | 6.96 | 🟡 AA |
| --fg-2 on --bg-3 | `var(--fg-2)` | `var(--bg-3)` | 6.72 | 🟡 AA |
| --fg-2 on --bg-hover | `var(--fg-2)` | `var(--bg-hover)` | 6.49 | 🟡 AA |
| --fg-2 on --bg-selected | `var(--fg-2)` | `var(--bg-selected)` | 5.97 | 🟡 AA |
| --fg-3 on --bg-0 | `var(--fg-3)` | `var(--bg-0)` | 4.12 | ❌ FAIL |
| --fg-3 on --bg-1 | `var(--fg-3)` | `var(--bg-1)` | 4.09 | ❌ FAIL |
| --fg-3 on --bg-2 | `var(--fg-3)` | `var(--bg-2)` | 3.99 | ❌ FAIL |
| --fg-3 on --bg-3 | `var(--fg-3)` | `var(--bg-3)` | 3.86 | ❌ FAIL |
| --fg-3 on --bg-hover | `var(--fg-3)` | `var(--bg-hover)` | 3.73 | ❌ FAIL |
| --fg-3 on --bg-selected | `var(--fg-3)` | `var(--bg-selected)` | 3.43 | ❌ FAIL |
...
| --err on --bg-0 | `var(--err)` | `var(--bg-0)` | 6.67 | 🟡 AA |
| --err on --bg-1 | `var(--err)` | `var(--bg-1)` | 6.62 | 🟡 AA |
| --err on --bg-2 | `var(--err)` | `var(--bg-2)` | 6.46 | 🟡 AA |
| --err on --bg-3 | `var(--err)` | `var(--bg-3)` | 6.24 | 🟡 AA |
...
| fg-0 on err (danger btn) | `var(--fg-0)` | `var(--err)` | 2.94 | ❌ FAIL |
| bg-0 on err (danger btn dark text) | `var(--bg-0)` | `var(--err)` | 6.67 | 🟡 AA |
...
| deleted on --bg-0 | `var(--color-status-deleted)` | `var(--bg-0)` | 6.67 | 🟡 AA |
| deleted on --bg-1 | `var(--color-status-deleted)` | `var(--bg-1)` | 6.62 | 🟡 AA |
| deleted on --bg-hover | `var(--color-status-deleted)` | `var(--bg-hover)` | 6.03 | 🟡 AA |
| deleted on --bg-selected | `var(--color-status-deleted)` | `var(--bg-selected)` | 5.55 | 🟡 AA |
...
| --lane-5 on --bg-1 | `var(--lane-5)` | `var(--bg-1)` | 8.10 | ✅ AAA |
| --lane-5 on --bg-selected | `var(--lane-5)` | `var(--bg-selected)` | 6.79 | 🟡 AA |
| --lane-6 on --bg-1 | `var(--lane-6)` | `var(--bg-1)` | 10.19 | ✅ AAA |
| --lane-6 on --bg-selected | `var(--lane-6)` | `var(--bg-selected)` | 8.54 | ✅ AAA |
| --lane-7 on --bg-1 | `var(--lane-7)` | `var(--bg-1)` | 7.71 | ✅ AAA |
| --lane-7 on --bg-selected | `var(--lane-7)` | `var(--bg-selected)` | 6.46 | 🟡 AA |
...
| keyword del | `var(--color-syn-keyword)` | `var(--bg-0)` + [var(--diff-del-bg)] | 8.33 | ✅ AAA |
| keyword add-selected | `var(--color-syn-keyword)` | `var(--bg-0)` + [var(--diff-add-hi)] | 7.12 | ✅ AAA |
| keyword del-selected | `var(--color-syn-keyword)` | `var(--bg-0)` + [var(--diff-del-hi)] | 7.60 | ✅ AAA |
| string context | `var(--color-syn-string)` | `var(--bg-0)` | 9.17 | ✅ AAA |
| string add | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-add-bg)] | 8.08 | ✅ AAA |
| string del | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-del-bg)] | 8.34 | ✅ AAA |
| string add-selected | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-add-hi)] | 7.13 | ✅ AAA |
| string del-selected | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-del-hi)] | 7.61 | ✅ AAA |
...
| function del | `var(--color-syn-function)` | `var(--bg-0)` + [var(--diff-del-bg)] | 13.37 | ✅ AAA |
| function add-selected | `var(--color-syn-function)` | `var(--bg-0)` + [var(--diff-add-hi)] | 11.43 | ✅ AAA |
| function del-selected | `var(--color-syn-function)` | `var(--bg-0)` + [var(--diff-del-hi)] | 12.21 | ✅ AAA |
...
| variable del | `var(--color-syn-variable)` | `var(--bg-0)` + [var(--diff-del-bg)] | 12.67 | ✅ AAA |
| variable add-selected | `var(--color-syn-variable)` | `var(--bg-0)` + [var(--diff-add-hi)] | 10.83 | ✅ AAA |
| variable del-selected | `var(--color-syn-variable)` | `var(--bg-0)` + [var(--diff-del-hi)] | 11.57 | ✅ AAA |
...
| constant del | `var(--color-syn-constant)` | `var(--bg-0)` + [var(--diff-del-bg)] | 9.36 | ✅ AAA |
| constant add-selected | `var(--color-syn-constant)` | `var(--bg-0)` + [var(--diff-add-hi)] | 8.00 | ✅ AAA |
| constant del-selected | `var(--color-syn-constant)` | `var(--bg-0)` + [var(--diff-del-hi)] | 8.55 | ✅ AAA |
...
| operator del | `var(--color-syn-operator)` | `var(--bg-0)` + [var(--diff-del-bg)] | 12.75 | ✅ AAA |
| operator add-selected | `var(--color-syn-operator)` | `var(--bg-0)` + [var(--diff-add-hi)] | 10.90 | ✅ AAA |
| operator del-selected | `var(--color-syn-operator)` | `var(--bg-0)` + [var(--diff-del-hi)] | 11.64 | ✅ AAA |
...
| punctuation del | `var(--color-syn-punctuation)` | `var(--bg-0)` + [var(--diff-del-bg)] | 8.33 | ✅ AAA |
| punctuation add-selected | `var(--color-syn-punctuation)` | `var(--bg-0)` + [var(--diff-add-hi)] | 7.11 | ✅ AAA |
| punctuation del-selected | `var(--color-syn-punctuation)` | `var(--bg-0)` + [var(--diff-del-hi)] | 7.60 | ✅ AAA |
...
| attribute del | `var(--color-syn-attribute)` | `var(--bg-0)` + [var(--diff-del-bg)] | 12.67 | ✅ AAA |
| attribute add-selected | `var(--color-syn-attribute)` | `var(--bg-0)` + [var(--diff-add-hi)] | 10.83 | ✅ AAA |
| attribute del-selected | `var(--color-syn-attribute)` | `var(--bg-0)` + [var(--diff-del-hi)] | 11.57 | ✅ AAA |
| tag context | `var(--color-syn-tag)` | `var(--bg-0)` | 9.15 | ✅ AAA |
| tag add | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-add-bg)] | 8.07 | ✅ AAA |
| tag del | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-del-bg)] | 8.33 | ✅ AAA |
| tag add-selected | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-add-hi)] | 7.12 | ✅ AAA |
| tag del-selected | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-del-hi)] | 7.60 | ✅ AAA |
...
| keyword word-del | `var(--color-syn-keyword)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.07 | 🟡 AA |
| string word-add | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.29 | 🟡 AA |
| string word-del | `var(--color-syn-string)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.08 | 🟡 AA |
| comment word-add | `var(--color-syn-comment)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.28 | 🟡 AA |
| comment word-del | `var(--color-syn-comment)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.06 | 🟡 AA |
| number word-add | `var(--color-syn-number)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 7.06 | ✅ AAA |
| number word-del | `var(--color-syn-number)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 8.10 | ✅ AAA |
| type word-add | `var(--color-syn-type)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.89 | 🟡 AA |
| type word-del | `var(--color-syn-type)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.76 | 🟡 AA |
| function word-add | `var(--color-syn-function)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 8.49 | ✅ AAA |
| function word-del | `var(--color-syn-function)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 9.75 | ✅ AAA |
| variable word-add | `var(--color-syn-variable)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 8.04 | ✅ AAA |
| variable word-del | `var(--color-syn-variable)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 9.23 | ✅ AAA |
| constant word-add | `var(--color-syn-constant)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.94 | 🟡 AA |
| constant word-del | `var(--color-syn-constant)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.82 | 🟡 AA |
| operator word-add | `var(--color-syn-operator)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 8.09 | ✅ AAA |
| operator word-del | `var(--color-syn-operator)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 9.29 | ✅ AAA |
| punctuation word-add | `var(--color-syn-punctuation)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.28 | 🟡 AA |
| punctuation word-del | `var(--color-syn-punctuation)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.07 | 🟡 AA |
| attribute word-add | `var(--color-syn-attribute)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 8.04 | ✅ AAA |
| attribute word-del | `var(--color-syn-attribute)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 9.23 | ✅ AAA |
| tag word-add | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.28 | 🟡 AA |
| tag word-del | `var(--color-syn-tag)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.07 | 🟡 AA |
| property word-add | `var(--color-syn-property)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 8.04 | ✅ AAA |
| property word-del | `var(--color-syn-property)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 9.23 | ✅ AAA |
| regex word-add | `var(--color-syn-regex)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 5.29 | 🟡 AA |
| regex word-del | `var(--color-syn-regex)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 6.07 | 🟡 AA |
| escape word-add | `var(--color-syn-escape)` | `var(--bg-0)` + [var(--diff-add-bg), var(--color-diff-word-add-bg)] | 6.40 | 🟡 AA |
| escape word-del | `var(--color-syn-escape)` | `var(--bg-0)` + [var(--diff-del-bg), var(--color-diff-word-delete-bg)] | 7.35 | ✅ AAA |
...
| diff-text del | `var(--color-diff-text)` | `var(--bg-0)` + [var(--diff-del-bg)] | 17.82 | ✅ AAA |
| diff-text add-sel | `var(--color-diff-text)` | `var(--bg-0)` + [var(--diff-add-hi)] | 15.23 | ✅ AAA |
| diff-text del-sel | `var(--color-diff-text)` | `var(--bg-0)` + [var(--diff-del-hi)] | 16.26 | ✅ AAA |
| diff-add marker on add | `var(--color-diff-add)` | `var(--bg-0)` + [var(--diff-add-bg)] | 8.32 | ✅ AAA |
| diff-del marker on del | `var(--color-diff-delete)` | `var(--bg-0)` + [var(--diff-del-bg)] | 6.07 | 🟡 AA |

### Text over tinted translucent backgrounds

| element | fg | bg | ratio | verdict |
|---|---|---|---|---|
| fg-2 on muted-bg over bg-1 | `var(--fg-2)` | `var(--bg-1)` + [var(--color-muted-bg)] | 6.68 | 🟡 AA |
| fg-1 on muted-bg over bg-1 | `var(--fg-1)` | `var(--bg-1)` + [var(--color-muted-bg)] | 12.65 | ✅ AAA |
...
| err on danger-bg over bg-1 | `var(--err)` | `var(--bg-1)` + [var(--color-danger-bg)] | 5.72 | 🟡 AA |
| err on danger-bg-subtle over bg-1 | `var(--err)` | `var(--bg-1)` + [var(--color-danger-bg-subtle)] | 6.20 | 🟡 AA |
| ok on success-bg over bg-1 | `var(--ok)` | `var(--bg-1)` + [var(--color-success-bg)] | 7.69 | ✅ AAA |
| fg-1 on accent-bg over bg-1 | `var(--fg-1)` | `var(--bg-1)` + [var(--color-accent-bg)] | 11.07 | ✅ AAA |
| accent on accent-bg over bg-1 | `var(--accent)` | `var(--bg-1)` + [var(--color-accent-bg)] | 7.84 | ✅ AAA |
