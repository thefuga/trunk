# Requirements Archive: v0.9 Multi-tab & Tree View
...
- [x] **TREE-11**: User can right-click a directory in the tree view to access bulk actions (Stage All, Unstage All, Discard All, and resolve/unresolve for conflicted files)
