...
- [x] **IREB-02**: User can reorder commits by dragging rows up/down in the rebase editor
- [x] **IREB-03**: Keyboard shortcuts assign actions to focused commit rows (P=Pick, S=Squash, R=Reword, D=Drop)
...
- [x] **IREB-06**: Reword action shows a message editor dialog when the rebase reaches that commit
- [x] **IREB-07**: Squash action combines the commit with its predecessor; a message editor shows the concatenated messages before execution
...
| IREB-06 | Phase 41 | Complete |
| IREB-07 | Phase 41 | Complete |
